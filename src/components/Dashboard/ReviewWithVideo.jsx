...
const ReviewWithVideo = () => {
  ...
  const fetchReviews = async () => {
    try {
      const response = await api.get("/api/reviews-with-video");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await api.patch(`/api/reviews-with-video/${editingId}`, formData);
        setSuccessMessage("Review updated successfully!");
      } else {
        await api.post("/api/reviews-with-video", formData);
  ...
  const handleDeleteConfirm = async () => {
    if (reviewToDelete) {
      try {
        await api.delete(`/api/reviews-with-video/${reviewToDelete._id}`);
  ...
  const toggleActive = async (review) => {
    try {
      await api.patch(`/api/reviews-with-video/${review._id}`, {
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600">
                  Manage customer video testimonials and reviews
                </p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="p-6 bg-white border border-gray-200 rounded-xl">
            <div className="text-2xl font-bold text-gray-900">
              {reviews.filter((r) => r.isActive).length}/4
            </div>
                ...
                <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-sm text-gray-600">
                      Preview of the YouTube profile image
                    </div>
                  </div>
                </div>
              )}
            ...
            {api.loading ? (
              ...
              <div className="py-12 text-center">
                ...
                <p className="mb-6 text-gray-600">
                  Get started by creating your first video review
                </p>
                <button
                ...
                {reviews.map((review) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      {review.videoUrl && (
                        <div className="flex items-center gap-2 text-blue-600 transition-colors duration-200 hover:text-blue-700">
                          <svg
                            className="w-4 h-4"
                            fill="currentColor"
                            viewBox="0 0 24 24"
